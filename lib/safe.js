...
module.exports = {
  ...
  typeCompare: baseConfig(Object.assign({}, baseObject(), {
    baseFunction: function ( variables ) {
      const { objectKeyValue, val } = variables
      return is(objectKeyValue) === val;
    },
    condition: function ( variables ) {
      const { val } = variables;
  ...
  valueCompare: baseConfig(Object.assign({}, baseObject(), {
    baseFunction: function ( variables ) {
      const { objectKeyValue, val } = variables
